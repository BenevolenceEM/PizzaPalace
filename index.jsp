...
<html lang="en">
    ...
    <body>
        ...
        <%
            HttpSession prodSession = request.getSession();
            ProductList products = new ProductList();
            
            List<Product> prods = products.getProducts();
            prodSession.setAttribute("products", prods);
...
<%
    String msg = c1 == null ? "<a href='#' class='account'>Sign up to earn rewards</a>" : "<a href='#' class='account'>Sign in to earn rewards</a>";
    out.println(msg);
%>
        ...
        <main>
            ...
            <h2 class="popular-1" style="margin-bottom: 0.5em;">Popular pizzas</h2>
            <div id="search">
            ...
            <section class="" style="display: grid;  grid-template-columns: auto auto auto; width: 100%; grid-template-rows: auto auto auto;"> 
                ...
                <div class="" >
                    ...
                    <div style="margin-bottom: 5%;padding-top: 3%;" >
                        ...
                        <%
                            double prices = p.getPrice();
                            String btnPrice = "<button class='buy-now'> $" + prices + "</button>";
                            out.println(btnPrice);
                        %>
                    </div>
